...
function createWave(elem) {
  ...
  var container = Ember.$('.ripple-waves',elem)[0];
  container.appendChild(outer);

  Ember.$('.ripple-bg',elem)[0].style.backgroundColor = fgColor;

  var wave = {
    bg: Ember.$('.ripple-bg',elem)[0],
    wc: outer,
    wave: inner,
    waveColor: fgColor,
    maxRadius: 0,
...
export default Ember.Component.extend(EventsMixin,{
  ...
  lastDownEventDidChange:Ember.observer('lastDownEvent',function(){
    this.down(this.get('lastDownEvent'));
  }),

  lastUpEventDidChange:Ember.observer('lastUpEvent',function(){
    this.up(this.get('lastUpEvent'));
  }),

  down:function(e){
    var wave = createWave(this.$()[0]);
  ...
  animate: function(ctx) {
    ...
    if (!this.waves.length && this._loop) {
      ...
      this.$('.ripple-bg')[0].style.backgroundColor = null;
      this._loop = null;
