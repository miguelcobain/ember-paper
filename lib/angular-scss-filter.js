  ...
  var newRule = content
    ...
    .replace(/'{{.*?}}'/g, function(themeExpression) {
      ...
      if (hue === 'color') {
        ...
        // Support for '{{background-hue-1}}'
        hue = LIGHT_DEFAULT_HUES[colorType]['hue-' + params[2]];
        params[2] = undefined;
      }
      ...
      if (params[2] === 'contrast') {
        // Support for '{{primary-500-contrast}}'
        colorExp = LIGHT_CONTRAST_COLOR;
